	...
	<div class="breadcrumbs" dir="rtl" style="margin-top: 25px;" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] != 'ar') echo ' dir="ltr"'; ?>>
		<div class="container">
			<div class="breadcrumbs-main">
				<ol class="breadcrumb">
					<li class="active"><?php language('login'); ?></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="contact" dir="rtl">
		<div class="container">
			<div class="contact-top heading" style="margin-bottom: 25px;">
				<h2><center><?php language('login'); ?></center></h2>
			</div>
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-4" style="margin-top: 25px;"><div class="submit-btn">
								<input type="submit" class="btn" style="background-color: #FDA30E;" name="loginsubmit" value="<?php language('login'); ?>">
							</div></div>
						</div>
						</form>
					</div>	
