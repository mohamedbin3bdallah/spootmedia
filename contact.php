	...
	<div class="contact" dir="rtl">
		<div class="container">
			<div class="contact-top heading" style="margin-bottom: 25px;">
				<h2><center><?php language('contact'); ?></center></h2>
			</div>
			<!--map-start-->
			<div class="map">
			...
			<!--map-end-->
				...
				<div class="contact-text">
					<div class="col-md-5 contact-left">
						<div class="address">
							<p><?php language('address'); echo ':'.$contact['address'.$lang_file]; ?></p>
						</div>
						<div class="address">
							<!--<h5>Address1</h5>-->
						...
						<div class="address">
							<?php if(isset($contact['email']) && $contact['email'] != '') { language('email'); ?>:<a href="mailto:<?php echo $contact['email']; ?>" style="color: #FDA30E;"><?php echo $contact['email']; ?></a><?php } ?></p>
						</div>
					</div>
					<div class="col-md-7 contact-right">
						<form action="develops/message.php" method="POST">
						<div class="row">
							<div class="col-md-3"><input type="text" class="form-control" style="background-color: #ffe6b3;" name="name" pattern="[a-zA-Z ]*" placeholder="<?php language('name'); ?>" required=""></div>
							<div class="col-md-3"><input type="text" class="form-control" style="background-color: #ffe6b3;" name="phone" pattern="[0-9]*" placeholder="<?php language('phone'); ?>" required=""></div>
							<div class="col-md-6"><input type="text" class="form-control" style="background-color: #ffe6b3;" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="<?php language('email'); ?>" required=""></div>
						</div>
						<div class="row">
							<div class="col-md-12"><textarea class="form-control" style="background-color: #ffe6b3;" name="message" placeholder="<?php language('message'); ?>" required=""></textarea></div>
						...
						<div class="row">
							<div class="col-md-12"><div class="submit-btn">
								<input type="submit" class="btn" style="background-color: #FDA30E;" name="sendmessage" value="<?php language('send'); ?>">
							</div></div>
						</div>
						</form>
					</div>	
