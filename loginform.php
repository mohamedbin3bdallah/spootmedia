...
if(isset($_POST['loginsubmit']))
{
	...
	if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false && $_POST['password'] != '')
	{
		...
		$user = getRowFromTable('users',' where email like "'.$_POST['email'].'" and password like "'.$_POST['password'].'"','');
		$admin = getRowFromTable('admins',' where email like "'.$_POST['email'].'" and password like "'.$_POST['password'].'"','');
