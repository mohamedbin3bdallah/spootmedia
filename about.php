			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="active menu__item menu__item--current"><a class="menu__link" href="about.php"><?php language('about'); ?><span class="sr-only">(current)</span></a></li>
	...
	<div class="contact" dir="rtl" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] != 'ar') echo ' dir="ltr"'; ?> >
		<div class="container">
			<div class="ckeck-top heading" style="margin-top: 25px;">
				<h2><center><?php language('about'); ?></center></h2>
			</div>
			<div class="ckeckout-top" style="margin-top: 25px;">
				<?php echo '<div><h3>'; language('vision'); echo '<h3></div>'; ?>
				<?php echo '<div style="text-align: justify; margin-top:15px;"><h4><p>'.$about['vision'].'</p><h4></div>'; ?>
			</div>
			<br><br><br>
			<div class="ckeckout-top" style="margin-top: 25px; margin-bottom: 25px;">
				<?php echo '<div><h3>'; language('mission'); echo '<h3></div>'; ?>
				<?php echo '<div style="text-align: justify; margin-top:15px;"><h4><p>'.$about['mission'].'</p><h4></div>'; ?>
			</div>
		</div>
	</div>	
...
<div class="footer" dir="rtl">
	<div class="container">
		...
		<div class="clearfix"></div>
		<p class="copy-right">&copy 2016 spoot media. All rights reserved | Design by <a href="http://onetrusted.com/">onetrusted</a></p>
	</div>
</div>
<!-- //footer -->
