...
<body> 
		...
		<div class="cart box_1">
			<a href="checkout.php">
				<h3> <div class="total">
					...
					<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'en') { echo $system['currency']; ?><span id="totalcart" class="/*simpleCart_total*/"><?php echo getCartTotal($ipaddress); ?></span>
					<?php } else { ?><span id="totalcart" class="/*simpleCart_total*/"><?php echo str_replace($western_arabic, $eastern_arabic, getCartTotal($ipaddress)); ?></span><?php echo ' '.$system['currency']; }  ?>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="contact.php"><?php language('contact'); ?><span class="sr-only">(current)</span></a></li>
	...
	<div class="breadcrumbs" dir="rtl" style="margin-top: 25px;" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] != 'ar') echo ' dir="ltr"'; ?>>
		<div class="container">
			<div class="breadcrumbs-main">
				<ol class="breadcrumb">
					<li class="active"><?php language('register'); ?></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="contact" dir="rtl">
		<div class="container">
			<div class="contact-top heading" style="margin-bottom: 25px;">
				<h2><center><?php language('register'); ?></center></h2>
			</div>
					<div class="col-md-12">
						...
						<div class="row">
							<label for="username" class="col-md-4 col-md-offset-2 col-md-pull-3 control-label" style="margin-top: 25px;"><?php language('username'); ?></label>
							<div class="col-md-4" style="margin-top: 25px;"><input type="text" class="form-control" style="background-color: #ffe6b3;" name="username" maxlength="250" pattern="[a-zA-Z]{5,}" placeholder="<?php language('username'); ?>" required=""></div>
						</div>
						<div class="row">
							<label for="email" class="col-md-4 col-md-offset-2 col-md-pull-3 control-label" style="margin-top: 25px;"><?php language('email'); ?></label>
							<div class="col-md-4" style="margin-top: 25px;"><input type="email" class="form-control" style="background-color: #ffe6b3;" name="email" maxlength="100" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="<?php language('email'); ?>" required=""></div>
						</div>
						<div class="row">
							<label for="password" class="col-md-4 col-md-offset-2 col-md-pull-3  control-label" style="margin-top: 25px;"><?php language('password'); ?></label>
							<div class="col-md-4" style="margin-top: 25px;"><input type="password" class="form-control" style="background-color: #ffe6b3;" name="password" placeholder="<?php language('password'); ?>" required=""></div>
						</div>
						<div class="row">
							<label for="cmfpassword" class="col-md-4 col-md-offset-2 col-md-pull-3  control-label" style="margin-top: 25px;"><?php language('cmfpassword'); ?></label>
							<div class="col-md-4" style="margin-top: 25px;"><input type="password" class="form-control" style="background-color: #ffe6b3;" name="cmfpassword" placeholder="<?php language('cmfpassword'); ?>" required=""></div>
						</div>
						<div class="row">
							<label for="cmfpassword" class="col-md-4 col-md-offset-2 col-md-pull-3  control-label" style="margin-top: 25px;"><?php language('dealer'); ?></label>
							<div class="col-md-4" style="margin-top: 25px;"><input type="checkbox" name="dealer" id="dealer"></div>
						</div>
						<div class="row" id="dealercompany">
							<label for="cmfpassword" class="col-md-4 col-md-offset-2 col-md-pull-3  control-label" style="margin-top: 25px;"><?php language('company'); ?></label>
							<div class="col-md-4" style="margin-top: 25px;"><input type="text" class="form-control" style="background-color: #ffe6b3;" name="company" id="company" maxlength="100" pattern="[a-zA-Z]{5,}" placeholder="<?php language('company'); ?>"></div>
						</div>
						<div class="row">
							<div class="col-md-4 col-md-offset-2" style="margin-top: 25px;"></div>
							<div class="col-md-4" style="margin-top: 25px;"><div class="submit-btn">
								<input type="submit" class="btn" style="background-color: #FDA30E;" name="registersubmit" value="<?php language('register'); ?>">
							</div></div>
						</div>
						</form>
					</div>	
