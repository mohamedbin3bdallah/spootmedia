			...
			<div class="col-md-12">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td class="warning"><input type="text" name="mobile" value="<?php echo $contact['mobile']; ?>" pattern="[0-9]*" maxlength="15" title="<?php language('quantitymatch'); ?>" class="form-control" /></td>
					</tr>
					<tr>
						<td class="info"><?php language('phone'); ?></td>
						<td class="warning"><input type="text" name="phone" value="<?php echo $contact['phone']; ?>" pattern="[0-9]*" maxlength="15" title="<?php language('quantitymatch'); ?>" class="form-control" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="info"><?php language('instagram'); ?></td>
						<td class="warning"><input type="url" name="instagram" value="<?php echo $contact['instagram']; ?>" maxlength="250" class="form-control" /></td>
					</tr>					
					<tr>
						<td class="info"></td>
