...
function language($lang)
{
	...
	$arr['m2'] = "يوجد خطا ما";
	$arr['m3'] = "تاكد من نوع الملف";
	$arr['m4'] = "اضف رابط الاعلان بشكل صحيح";
	...
	$arr['active'] = "مفعل";
	$arr['admin'] = "المدير";
	$arr['newadmin'] = "مدير جديد";
	$arr['noadmins'] = "لا يوجد مديرين";
	$arr['deleteadminmodal'] = "هل انت متاكد من رغبتك في حذف هذا المدير ؟";
	...
	$arr['changeimage'] = "تغيير السلايدر";
	...
	$arr['cmfpassword'] = "تاكيد كلمة المرور";
	$arr['remember'] = "تذكرني";
	$arr['close'] = "اغلاق";
	$arr['login'] = "دخول";
	$arr['logout'] = "خروج";
