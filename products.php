	...
	<div class="contact">
		<div class="container">
			<div class="ckeck-top heading" style="margin-bottom: 25px;">
				<h2><center><?php language('products'); ?></center></h2>
			</div>
			<div class="single-main">
				...
				<nav>
					<ul class="pagination">
						<?php if($totalPages > 1) { ?><li style="<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') echo 'float:right;'; ?>"><a href="?page=1<?php if(isset($_GET['q'])) { echo '&category='.$_GET['category'].'&q='.$_GET['q']; } ?>"><?php language("first"); ?></a></li><?php } ?>
						...
						<?php if($page > 1) { ?><li style="<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') echo 'float:right;'; ?>"><a href="?page=<?php echo $page-1; ?><?php if(isset($_GET['q'])) { echo '&category='.$_GET['category'].'&q='.$_GET['q']; } ?>"><?php echo $page-1; ?></a></li><?php } ?>
						<?php if($totalPages > 1) { ?><li style="<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') echo 'float:right;'; ?>"><a href="?page=<?php echo $page; ?><?php if(isset($_GET['q'])) { echo '&category='.$_GET['category'].'&q='.$_GET['q']; } ?>"><?php echo $page; ?></a></li><?php } ?>
						<?php if($page < $totalPages) { ?><li style="<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') echo 'float:right;'; ?>"><a href="?page=<?php echo $page+1; ?><?php if(isset($_GET['q'])) { echo '&category='.$_GET['category'].'&q='.$_GET['q']; } ?>"><?php echo $page+1; ?></a></li><?php } ?>
						...
						<?php if($totalPages > 1) { ?><li style="<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') echo 'float:right;'; ?>"><a href="?page=<?php echo $totalPages; ?><?php if(isset($_GET['q'])) { echo '&category='.$_GET['category'].'&q='.$_GET['q']; } ?>"><?php language("last"); ?></a></li><?php } ?>
					</ul>
				</nav>
				</div>
				</div>
				
				<?php } else {  ?><div dir="rtl" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'en') echo ' dir="ltr"'; ?>><?php language('noproducts'); } ?></div>
			</div>
				<div class="col-md-3 <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') echo ' col-md-pull-9 '; ?> single-right">
					...
					<div class="css-treeview">
						<h4><?php language('categories'); ?></h4>
						<ul class="tree-list-pad">
							<?php $k = 1; for($j=0;$j<count($flcategories);$j++) { ?>
								<li><input type="checkbox" id="category"  name="category" value="<?php echo $flcategories[$j]['childto']; ?>" onclick="gotoproducts(this.value,'<?php if(isset($_GET['q'])) echo $_GET['q']; ?>');" <?php if(isset($_GET['category']) && $_GET['category'] == $flcategories[$j]['childto']) echo 'checked';?> /><label for="item-<?php echo $j; ?>"><span></span><?php echo $flcategories[$j]['title']; ?></label>
									<ul>
										<?php $mlcategories = getMLevelCategories($flcategories[$j]['childto'],$lang_file); for($m=0;$m<count($mlcategories);$m++) { ?>
											<li><input type="checkbox" id="category" name="category" value="<?php echo $mlcategories[$m]['childto']; ?>" onclick="gotoproducts(this.value,'<?php if(isset($_GET['q'])) echo $_GET['q']; ?>');" <?php if(isset($_GET['category']) && $_GET['category'] == $mlcategories[$m]['childto']) echo 'checked';?>><label for="item-<?php echo $j; ?>-<?php echo $m; ?>"><?php echo $mlcategories[$m]['title']; ?></label></li>
										<?php } ?>
									</ul>
								</li>
							<?php } ?>
